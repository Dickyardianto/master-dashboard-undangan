          ...
          <form action="">
            ...
            <div class="card-body" style="padding-bottom: 0px;">
              <div class="form-group" style="margin-bottom: 0px;">
                ...
                <input type="text" class="form-control" name="instagram"  @if($sosial_media_wanita->instagram == null) {
                  value="Tidak ada instagram"
                } @else {
                  value="{{ $sosial_media_wanita->instagram }}"
                } @endif disabled>
                <label for="" class="text-danger">
                  @error('instagram')
                    {{ $message }}
              ...
              <div class="mb-3">
                  ...
                  <input class="form-control" type="text" id="twitter" name="twitter"  @if($sosial_media_wanita->twitter == null) {
                    value="Tidak ada twitter"
                  } @else {
                    value="{{ $sosial_media_wanita->twitter }}"
                  } @endif disabled>
                  <label for="" class="text-danger">
                    @error('twitter')
                      {{ $message }}
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="text" id="facebook" name="facebook"  @if($sosial_media_wanita->facebook == null) {
                  value="Tidak ada facebook"
                } @else {
                  value="{{ $sosial_media_wanita->facebook }}"
                } @endif disabled>
                <label for="" class="text-danger">
                  @error('facebook')
                    {{ $message }}
