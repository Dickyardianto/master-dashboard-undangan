<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html">Nyebar Undangan</a>
      </div>
      <div class="sidebar-brand sidebar-brand-sm">
        <a href="index.html">YU</a>
      </div>
      <ul class="sidebar-menu">
          <li class="menu-header">Dashboard</li>
          <li class="nav-item dropdown">
            <a href="#" class="nav-link has-dropdown"><i class="far fa-user"></i><span>Client</span></a>
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="{{ route('index') }}">Daftar Client</a></li>
              <li><a class="nav-link" href="{{ route('tambah-data') }}">Tambah Client</a></li>
            </ul>
          </li>
